            ...
            <main class="content">
                <div>
                    ...
                    <div id="perfil">
                                ...
                                <div class="form-container">
                                    <div class="form-block">
                                        <div class="form-item">
                                            ...
                                            <br>
                                            <div>
                                                <input for="realPass" type="password" name="realPass" id="realPass"
                                                    required>
                                                <br />
                                                <br />
                        ...
                        <section class="modify-profile">
                            <form action="../login/src/logout.php" method="POST">
                                <h1>¡Te estaremos esperando!</h1>
                                <div class="form-container">
                                    <input class="btn-save" type="submit" value="Cerrar sesion">
                                </div>
                            </form>
                        </section>
                    </div>
